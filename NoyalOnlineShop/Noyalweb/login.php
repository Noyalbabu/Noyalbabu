         ...
         <div class="main">
             <div class="loginAnimation">
                 <div id="loginbutton" class="modal">
                     ...
                     <div class="imgcontainer">
                         <span onclick="document.getElementById('loginbutton').style.display='none'" class="close"
             ...
             <div class="loginAnimation">
                 <div id="signInbutton" class="modal">
                     ...
                     <div class="imgcontainer">
                         <span onclick="document.getElementById('signInbutton').style.display='none'" class="close"
                             title="Close Modal">&times;</span>
                         <img src="images/login.png">
                     </div>
                     <?php 
